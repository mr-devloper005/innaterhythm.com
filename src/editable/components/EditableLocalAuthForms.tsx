...
const inputClass = 'h-12 rounded-2xl border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-black outline-none transition placeholder:text-black/35 focus:border-black'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-2xl bg-black px-6 text-sm font-black uppercase tracking-[0.16em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
