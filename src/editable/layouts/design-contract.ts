...
export const editableRootStyle = {
  ...
  '--slot4-accent-soft': '#eef3ed',
  '--slot4-dark-bg': '#111111',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e7eaec',
  '--slot4-cream': '#f7f4ed',
  '--slot4-warm': '#f4f5f6',
  '--slot4-lavender': '#eef3ed',
  '--slot4-gray': '#f4f5f6',
  '--slot4-body-gradient': 'linear-gradient(180deg, #fbfaf7 0%, #f4f5f6 45%, #ffffff 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    eyebrow: 'text-xs font-black uppercase tracking-[0.12em]',
    heroTitle: 'text-4xl font-black leading-[1.04] tracking-normal sm:text-5xl lg:text-6xl',
